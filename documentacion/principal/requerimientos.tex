...
\\%
\\%
Por medio de un software el cual esta adecuado para poder administrar los procesos, como los inventarios de insumo que el administrara dichos productos y tendrá el debido control para no tener perdida de informaci\'on y tener informaci\'on necesaria al instante.
\\%
\\%
...
\\%
\\%
Definir\'iamos como alta aunque quedar\'ia muy robusto por la calidad de datos que ingresara cada departamento de la organizaci\'on y su base de datos la cual se actualizara con cada informaci\'on nueva obtenida. El software tendr\'a un alto desempeño con espuestas inmediatas y f\'acil control de consultas.
\\%
\\%
